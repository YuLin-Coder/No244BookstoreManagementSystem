...
import com.book.project.system.notice.domain.Notice;
import com.book.project.system.notice.service.INoticeService;
...
import com.book.common.constant.ShiroConstants;
...
import com.book.framework.config.BookConfig;
import com.book.framework.shiro.service.PasswordService;
...
import com.book.project.system.menu.domain.Menu;
import com.book.project.system.menu.service.IMenuService;
...
public class IndexController extends BaseController
{
    ...
    public String index(ModelMap mmap)
    {
        ...
        mmap.put("copyrightYear", bookConfig.getCopyrightYear());
        mmap.put("demoEnabled", bookConfig.isDemoEnabled());
    ...
    {
        List<BookPic> bookPics = bookPicService.selectBookPicList(new BookPic());
        for(BookPic pic : bookPics){

            if(pic.getType() == 1){
                String picAdress = pic.getPicAdress();
                String title = pic.getTitle();
                Long id = pic.getId();
                model.addAttribute("pic"+id, picAdress);
                model.addAttribute("title"+id, title);
            }
        }
